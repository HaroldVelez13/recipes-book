...
@Controller('api/article/:recipeId/comment')
export class CommentController {
  ...
  getAll(
    ...
    try {
      return this.service.getComments(recipeId, page, take);
    } catch (err) {
  ...
  async create(
    ...
    try {
      return await this.service.createComment(recipeId, commentDto, user.email);
    } catch (err) {
